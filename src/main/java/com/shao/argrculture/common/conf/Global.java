 ...
 */
package com.shao.argrculture.common.conf;
...
public class Global {
	 ...
	 * 允许下载的文件后缀名
	 */
	public static final String allowFileReg = ".+\\.(?i)(bmp|dib|rle|emf|gif|jpg|jpeg|jpe|jif|pcx|dcx|pic|png|tga|tif|tiffxif|wmf|jfif|rar|zip|pdf|txt|doc|docx|xls|xlsx|ppt|pptx|wps|wav|rm|mp3|mp4|wma|avi|mpg)$";
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	/**
	 * 日期插件多语言
	 * @see ${fns:getDatePickLan('zh_CN')}
	 */
	public static String getDatePickLan(String lan) {
		if(lan.equals("zh_CN")){
			return "zh-cn";
